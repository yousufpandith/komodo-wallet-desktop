...
set(DEX_PROJECT_NAME "ui-dex-wallet")
set(DEX_DISPLAY_NAME "Ui-dex Wallet")
set(DEX_MAINTENANCE_TOOL_NAME "Ui-dex Wallet Maintenance Tool")
set(DEX_COMPANY "ShorelineCrypto")
set(DEX_WEBSITE "https://cheetahdex.shorelinecrypto.com/")
set(DEX_VERSION "0.9.0")
set(DEX_SUPPORT_PAGE "https://support.komodoplatform.com/support/home")
set(DEX_DISCORD "https://discord.com/invite/jZMyhKm")
set(DEX_TWITTER "https://x.com/shorelinecrypto")
set(DEX_PRIMARY_COIN "CHTA")                                                  ## Main coin of the DEX, will be enabled by default and will be the default left ticker for trading
...
set(DEX_REPOSITORY_NAME "ui-dex-wallet-desktop")
set(DEX_CHECKSUM_API_URL "https://komodo.earth/static/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "ui-dex")
else ()
    set(DEX_APPDATA_FOLDER "ui-dex")
endif ()
