# Uidd-Dex wallet Pro alpha build instructions
...
## Create Uidd-Dex wallet Pro Installer
...
- Build Uidd-Dex wallet Pro `./ci_tools_atomic_dex build release`
